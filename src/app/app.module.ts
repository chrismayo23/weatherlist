...
import { DeleteCityDialogComponent } from './components/delete-city-dialog/delete-city-dialog.component';
...
@NgModule({
  ...
  entryComponents: [AddCityDialogComponent, DeleteCityDialogComponent]
})
